...
const showroomImages = {
  ...
  'brands/playply.webp': image('/images/showroom/brands/playaply-campaign-20260903.jpg', 'PLAYAPLY 品牌造型肖像', 'PLAYAPLY campaign portrait'),
  'brands/alwools.webp': image('/images/showroom/brands/alwools-campaign-20260903.jpg', 'ALWOOLS 品牌造型肖像', 'ALWOOLS campaign portrait'),
  'brands/tenspher.webp': image('/images/showroom/brands/tenspher-campaign-20260903.jpg', 'TENSPHER 品牌造型肖像', 'TENSPHER campaign portrait'),
  'brands/4mile.webp': image('/images/showroom/brands/4mile-campaign-20260903.webp', '4MILE 品牌造型肖像', '4MILE campaign portrait'),
  'brands/datt.webp': image('/images/showroom/brands/datt-campaign-20260903.jpg', 'DATT 品牌造型肖像', 'DATT campaign portrait'),
  'brands/pieton-episode.webp': image('/images/showroom/brands/pieton-episode-campaign-20260903.webp', 'PIÉTON ÉPISODE 鞋履海报', 'PIÉTON ÉPISODE footwear campaign'),
  'brands/lucia-tacci.webp': image('/images/showroom/brands/lucia-tacci-campaign-20260903.jpg', 'LUCIA TACCI 品牌造型肖像', 'LUCIA TACCI campaign portrait'),
  'brands/helen-kaminski.webp': image('/images/showroom/brands/helen-kaminski-campaign-20260903.jpg', 'HELEN KAMINSKI 品牌造型肖像', 'HELEN KAMINSKI campaign portrait'),
  'brands/reindeer.webp': image('/images/showroom/brands/reindeer-campaign-20260903.webp', 'REINDEER 项链海报', 'REINDEER necklace campaign'),
  ...
  'brand-room/playply-main.webp': image('/images/showroom/brand-room/playply-main.webp', 'PLAYAPLY 品牌造型肖像', 'PLAYAPLY campaign portrait'),
  'brand-room/playply-detail-01.webp': image('/images/showroom/brand-room/playply-detail-01.webp', 'PLAYAPLY 品牌造型肖像', 'PLAYAPLY campaign portrait'),
  'brand-room/playply-detail-02.webp': image('/images/showroom/brand-room/playply-detail-02.webp', 'PLAYAPLY 品牌造型肖像', 'PLAYAPLY campaign portrait'),
...
export const brands: Brand[] = [
  ...
  { slug: 'yifu-lu', name: 'YIFU LU', category: 'RTW', city: { cn: '', en: '' }, introduction: { cn: '', en: '' }, cover: showroomImage('brands/yifu-lu-campaign-20260903.jpg'), roomImages: [showroomImage('brands/yifu-lu-campaign-20260903.jpg')] },
  { slug: 'them-hub', name: 'THEM HUB', category: 'RTW', city: { cn: '', en: '' }, introduction: { cn: '', en: '' }, cover: showroomImage('brands/them-hub-campaign-20260903.jpg'), roomImages: [showroomImage('brands/them-hub-campaign-20260903.jpg')] },
  { slug: 'veilen', name: 'VEILEN', category: 'RTW', city: { cn: '', en: '' }, introduction: { cn: '', en: '' }, cover: showroomImage('brands/veilen-campaign-20260903.jpg'), roomImages: [showroomImage('brands/veilen-campaign-20260903.jpg')] },
...
export const currentEvent: CurrentEvent = {
  ...
  exhibitionBrands: [
    ...
    { slug: 'yifu-lu', name: 'YIFU LU', poster: showroomImage('brands/yifu-lu-campaign-20260903.jpg'), items: [{ image: showroomImage('brands/yifu-lu-campaign-20260903.jpg') }] },
    { slug: 'them-hub', name: 'THEM HUB', poster: showroomImage('brands/them-hub-campaign-20260903.jpg'), items: [{ image: showroomImage('brands/them-hub-campaign-20260903.jpg') }] },
    { slug: 'veilen', name: 'VEILEN', poster: showroomImage('brands/veilen-campaign-20260903.jpg'), items: [{ image: showroomImage('brands/veilen-campaign-20260903.jpg') }] },
    ...
    { slug: 'playply', name: 'PLAYAPLY', poster: showroomImage('brands/playply.webp'), items: editorialLookbook },
  ],
...
export const recaps: Recap[] = [
  {
    slug: '27ps-echoes-of-deco',
    season: '2027 PRE-SPRING & CAPSULE',
    title: { cn: 'Echoes of Deco', en: 'Echoes of Deco' },
    poster: '/images/showroom/recap/echoes-of-deco-27ps.webp',
    posterRatio: '1772 / 2362',
    order: 0,
    city: { cn: '上海', en: 'Shanghai' },
    date: { cn: '2026年7月6日 — 2026年8月31日', en: 'July 6 – August 31, 2026' },
    description: {
      cn: '27早春＆胶囊系列订货会 · Echoes of Deco。地址：上海市黄浦区会馆街55号绿地外滩中心T3栋41F。',
      en: '2027 Pre-Spring & Capsule Collection ordering event · Echoes of Deco. Venue: 41F, Tower T3, Greenland Bund Center, 55 Huiguan Street, Huangpu District, Shanghai.',
    },
    pages: [],
    gallery: [],
  },
  {
    slug: 'aw-2026-floral-rhythm',
    season: 'AW 2026',
    title: { cn: 'Floral Rhythm', en: 'Floral Rhythm' },
    poster: '/images/showroom/recap/floral-rhythm-aw2026.webp',
    posterRatio: '3543 / 3543',
    order: 1,
    city: { cn: '上海', en: 'Shanghai' },
    date: { cn: '2026年3月25日 — 2026年5月31日', en: 'March 25 – May 31, 2026' },
    description: {
      cn: '26秋冬系列订货会 · Floral Rhythm。地址：上海市黄浦区会馆街51号40/41F。',
      en: 'Autumn / Winter 2026 ordering event · Floral Rhythm. Venue: 40/41F, 51 Huiguan Street, Huangpu District, Shanghai.',
    },
    pages: [],
    gallery: [],
  },
  {
    slug: 'pre-fall-2026-to-be-nowhere',
    season: '2026 PRE-FALL',
    title: { cn: 'To Be Nowhere', en: 'To Be Nowhere' },
    poster: '/images/showroom/recap/to-be-nowhere-2026.webp',
    posterRatio: '833 / 1250',
    order: 2,
    city: { cn: '上海', en: 'Shanghai' },
    date: { cn: '2026年1月31日 — 2026年2月4日', en: 'January 31 – February 4, 2026' },
    description: {
      cn: '2026早秋订货会 · To Be Nowhere。地址：上海市静安区光复路195号光二仓库3F。',
      en: 'Pre-Fall 2026 ordering event · To Be Nowhere. Venue: 3F, Guang\'er Warehouse, 195 Guangfu Road, Jing\'an District, Shanghai.',
    },
    pages: [],
    gallery: [],
  },
  {
    slug: 'ss-2026',
    season: 'SS 2026',
    title: { cn: 'Boom Boom House', en: 'Boom Boom House' },
    poster: '/images/showroom/recap/boom-boom-house-ss2026.webp',
    posterRatio: '737 / 1024',
    order: 3,
    city: { cn: '上海', en: 'Shanghai' },
    date: { cn: '2025年10月9日 — 2025年10月14日', en: 'October 9–14, 2025' },
    description: {
      cn: '2026春夏系列订货会 · Boom Boom House。地址：上海市黄浦区会馆街51号绿地外滩中心T3栋39F。',
      en: 'Spring / Summer 2026 ordering event · Boom Boom House. Venue: 39F, Tower T3, Greenland Bund Center, 51 Huiguan Street, Huangpu District, Shanghai.',
    },
    pages: [],
    gallery: [],
  },
  {
    slug: 'pre-spring-2026-piega-del-tempo',
    season: '2026 PRE-SPRING',
    title: { cn: '时间褶皱 | Piega del Tempo', en: 'Piega del Tempo' },
    poster: '/images/showroom/recap/piega-del-tempo-2026.webp',
    posterRatio: '768 / 1024',
    order: 4,
    city: { cn: '上海', en: 'Shanghai' },
    date: { cn: '2025年7月13日 — 2025年7月18日', en: 'July 13–18, 2025' },
    description: {
      cn: '26早春订货会 · 时间褶皱 | Piega del Tempo。地址：上海市静安区光复路195号百空间光二仓库。',
      en: 'Pre-Spring 2026 ordering event · Piega del Tempo. Venue: Bai Space, Guang\'er Warehouse, 195 Guangfu Road, Jing\'an District, Shanghai.',
    },
    pages: [],
    gallery: [],
  },
  {
    slug: 'aw-2025',
    season: 'AW 2025',
    title: { cn: 'YuanShowroom X Coop Room', en: 'YuanShowroom X Coop Room' },
    poster: '/images/showroom/recap/yuan-coop-room-2025.webp',
    posterRatio: '750 / 1000',
    order: 5,
    city: { cn: '上海', en: 'Shanghai' },
    date: { cn: '2025年3月24日 — 2025年3月29日', en: 'March 24–29, 2025' },
    description: {
      cn: 'YuanShowroom X Coop Room 订货会。地址：上海市黄浦区会馆街55号绿地外滩中心I3栋39楼。',
      en: 'YuanShowroom X Coop Room ordering event. Venue: 39F, Building I3, Greenland Bund Center, 55 Huiguan Street, Huangpu District, Shanghai.',
    },
    pages: [],
    gallery: [],
  },
  { slug: 'ss-2025', season: 'SS 2025', title: { cn: '流动的秩序', en: 'Order in Motion' }, poster: showroomImage('recap/ss-2025.webp'), order: 6, pages: [], gallery: [] },
  { slug: 'aw-2024', season: 'AW 2024', title: { cn: '静默的力量', en: 'The Power of Stillness' }, poster: showroomImage('recap/aw-2024.webp'), order: 7, pages: [], gallery: [] },
  { slug: 'ss-2024', season: 'SS 2024', title: { cn: '轻盈之诗', en: 'A Poem of Lightness' }, poster: showroomImage('recap/ss-2024.webp'), order: 8, pages: [], gallery: [] },
  { slug: 'aw-2023', season: 'AW 2023', title: { cn: '本质回归', en: 'Return to Essence' }, poster: showroomImage('recap/aw-2023.webp'), order: 9, pages: [], gallery: [] },
  { slug: 'ss-2023', season: 'SS 2023', title: { cn: '自然共生', en: 'Nature in Symbiosis' }, poster: showroomImage('recap/ss-2023.webp'), order: 10, pages: [], gallery: [] },
  { slug: 'aw-2022', season: 'AW 2022', title: { cn: '时间的刻度', en: 'The Measure of Time' }, poster: showroomImage('recap/aw-2022.webp'), order: 11, pages: [], gallery: [] },
  { slug: 'ss-2022', season: 'SS 2022', title: { cn: '光影之间', en: 'Between Light and Shadow' }, poster: showroomImage('recap/ss-2023.webp'), order: 12, pages: [], gallery: [] },
  { slug: 'aw-2021', season: 'AW 2021', title: { cn: '序章', en: 'Prologue' }, poster: showroomImage('recap/aw-2022.webp'), order: 13, pages: [], gallery: [] },
]
