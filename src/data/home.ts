...
export const hero = {
  ...
  tagline: '从我们相遇的那一刻起，YUAN 不只是一个平台，更是一种始终以品牌为中心、陪伴其扩展、连接世界的系统。',
  taglineEn: 'From the moment we meet, YUAN is more than a platform — it is a system that always puts the brand at its center, accompanying its growth and connecting it to the world.',
  closing: '我们以你为圆心，以时尚为半径。',
  closingEn: 'We take you as the center, and fashion as the radius.',
  cta: {
    primary: { label: '品牌合作洽谈', href: '#contact' },
    secondary: { label: '了解 YUAN 模式', href: '#bsi' },
  },
}
...
export const about = {
  ...
  intro: 'YUAN Showroom 立足深圳和香港，是一家立足中国市场、融合国际视野的时尚产业化运营机构，集品牌代理、市场开拓、运营管理、全域营销与战略投资于一体的综合性品牌管理支持平台。',
  intro2: 'YUAN 以品牌批发业务拓展为核心、品牌全方位市场推广服务、零售体系搭建及战略投资业务，为全球设计师品牌提供中国市场全链路解决方案。每年固定在上海举办早春、春夏、早秋及秋冬四次季节性大型时装订货会。核心团队深耕行业多年，凭借国际视野与本土化运营经验，目前独家运营中国、欧洲、亚洲等超过 50+ 设计师品牌。',
  intro3: '我们相信，每一个品牌都有其独特的圆心；YUAN 所做的，是成为那条从圆心出发、不断延展的"半径"——连接创意、市场与世界，见证品牌成长轨迹。',
  link: { label: '探索服务体系', href: '#services' },
}
...
export const bsi = {
  ...
  intro: 'YUAN Showroom 基于对中国时尚行业的深度洞察，自主搭建「BSI」商业模型 (Buyer-Showroom-Investment)。我们不是一个中转式的买手平台，而是一个以"系统运营力"驱动的品牌发展生态。',
  pillars: [
    {
      id: 'service',
      title: '服务体系',
      enTitle: 'Service System',
      desc: '覆盖品牌全生命周期的一站式服务 — 从品牌咨询、市场调研、产品开发建议，到订货分销、销售维护、新媒体运营，再到电商零售、投资支持，打造从"品牌起步"到"市场成熟"的全链路协作结构。',
    },
    {
      id: 'team',
      title: '团队能力',
      enTitle: 'Team Capability',
      desc: '拥有操盘 100+ 品牌从 0 到亿的实战经验。聚集品牌策略顾问、资深销售、市场数据分析和公关内容团队，建立"从创意到落地"的高效执行力矩阵。品牌发展需要长期陪伴与阶段性策略共同推动。',
    },
    {
      id: 'network',
      title: '行业纵深',
      enTitle: 'Industry Network',
      desc: '覆盖全国乃至国际的销售与合作网络，连接超过 3000+ 买手店与百货渠道。既是海外品牌进入中国市场的门户，也是中国品牌出海的桥梁。YUAN 不只是连接，更参与品牌在不同市场的落地全过程。',
    },
  ],
}
...
export const showroom = {
  ...
  description: '5000+㎡ 沉浸式展厅空间，每季设立符合当季的创意主题及视觉主题。整体时装周围绕当季主题展开布置，现场设置艺术打卡区域、咖啡服务、冷餐服务、酒水服务等，突破传统时装周单一订货的服务体系。',
  ...
  images: [
    ...
    { src: '/images/home/showroom-grid-01.jpeg', alt: 'Showroom 空间展示' },
    { src: '/images/home/showroom-grid-02.jpeg', alt: 'Showroom 沉浸式体验' },
    { src: '/images/home/showroom-grid-03.jpeg', alt: 'Showroom 订货会现场' },
    { src: '/images/home/showroom-grid-04.jpeg', alt: 'Showroom 品牌陈列' },
  ],
}
...
export const prStars = {
  ...
  intro2: '同时为品牌提供中国地区自媒体代运营服务，从账号搭建、内容本土化、矩阵运营到销售转化的全托管服务，实现从 0 到 1 的品牌认知建设与用户资产沉淀。',
  overseas: [
...
export const intangibleAsset = {
  ...
  desc: '通过财务分析、市场调查等方法评估品牌的市场价值和投资回报，管理和优化品牌的无形资产，提高品牌的市场竞争力、增加盈利能力和提升品牌整体价值。',
  highlights: [
    ...
    { title: '金融资源支持', enTitle: 'Financial Support', desc: '强大的金融背景为品牌提供资金与资源对接' },
...
export const cta = {
  ...
  closing: 'YUAN，是你成长轨迹的见证者，也是你信任的共创伙伴。',
  closingEn: 'YUAN is here to witness your growth and to be your trusted partner in creation.',
  primary: { label: '预约洽谈', href: '#contact' },
  secondary: { label: '品牌入驻申请', href: '#contact' },
}
