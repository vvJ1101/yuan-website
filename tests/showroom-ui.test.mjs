...
test('cover uses editorial image fragments and split transparent lettering', async () => {
  ...
  assert.match(source, /home\/generated-fabric-v1\.png/)
  assert.match(source, /home\/flower-monochrome\.png/)
  assert.match(source, /'YUAN'\.split\(''\)\.map/)
  assert.match(source, /'SHOWROOM'\.split\(''\)\.map/)
  assert.match(source, /showroom-cover__letter-layer--base/)
  assert.match(source, /showroom-cover__letter-layer--fabric/)
  assert.match(source, /showroom-cover__letter-layer--texture/)
  assert.match(source, /showroom-cover__letter-layer--monochrome/)
  assert.match(source, /showroom-cover__letter-layer--macro/)
  assert.match(css, /\.showroom-cover__letter-layer--base\s*\{[^}]*color: rgb\(8 8 8 \/ 78%\)/)
  assert.match(css, /\.showroom-cover__letter-layer--fabric\s*\{[^}]*clip-path: inset/)
  assert.match(css, /\.showroom-cover__letter-layer--macro\s*\{[^}]*clip-path: inset/)
  ...
  assert.doesNotMatch(source, /paper-sculpture\.png/)
